...
table DS(k,h)
     1      2       3      4      5       6       7       8
k1  1.03  0.268    -3     -3.97  -3.732  -4.695  -3.45   -2.416
k2  -0.95  -1.95   -2.95  -2.95  -3.97   -4.081  -4.04   -3
;
...
MP(h,s) price of microgrid energy
Expected_cost
eta(s,r)
VAR
CVAR
...
Eq1aa(k,s,r) .. CEE(k,s,r)=e=sum(h,(GP(h,s)*GE(k,h,s,r))+(MP(h,s)*DS(k,h)));
...
Eq21(k,h,s,r) .. sum(i,SO(k,i,h)*P(k,i))+ECH(k,h,s,r)=l=GE(k,h,s,r)+RE(k,h,r)+EDCH(k,h,s,r)+DS(k,h);
Eq23(h,s) .. MP(h,s)=l=GP(h,s);
...
display Expected_cost.l,y.l,CE.l,SO.l,CVAR.l,RE.l,SE.l,ECH.l,EDCH.l,SP.l,GE.l,US.l,CD.l,MP.l,CEE.l;

execute_unload 'D:\UCout.gdx',Expected_cost,y,cnotrade,CVAR,CE,SO,RE,SE,ECH,EDCH,SP,GE,DS,GE,US,CD,MP,CEE,GP,P,RQ,t,d,rt;
